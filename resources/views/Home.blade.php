    ...
    <center>
        ...
        @forelse ( $fullname as $keys => $value )
                <tr class="justify-center">
                    ...
                    <td class="border px-4 py-2">
                        <form action="{{ route('edit.user' , ['id' => $value->id])}}" method="post" class="flex justify-center" >
                        @csrf
                    ...
                    <td class="border px-4 py-2">
                        <form  action=" {{route('delete.user', ['id' => $value->id]) }} " method="post" class="flex justify-center">
                        @csrf
                        @method("DELETE")
        ...
        <section class="text-center">
            <form action="{{route('create.user')}}" method="get" class="pt-10"> 
