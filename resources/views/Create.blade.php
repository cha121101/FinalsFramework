...
<body>
    <center>
        <form class="w-full max-w-lg py-10 pl-10 my-28 border-solid border-2 border-sky-500 " action="{{ route('store.user')}}" method="post">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" name="fullname" >
                            </div>
